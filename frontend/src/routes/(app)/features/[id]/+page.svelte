...
<div class="flex-1 w-full flex">
	<div class="column flex-1 gap-4 px-16 py-24">
		...
		<section class="column gap-2">
			...
			<textarea class="flex-1 w-full min-h-[8lh] transparent-text-area rounded-lg" value={feature.description} onblur={async (e) => await updateFeatureMutation({})({ id: data.feature.id, description: e.currentTarget.value })}/>
		</section>
		<div class="gallery gap-4">
			<section class="column flex-1 gap-2">
				<span class="text-sm text-muted-foreground">Constraints</span>
				<textarea class="flex-1 w-full min-h-[8lh] transparent-text-area rounded-lg" value={feature.constraints} onblur={async (e) => await updateFeatureMutation({})({ id: data.feature.id, constraints: e.currentTarget.value })}/>
			</section>
			<section class="column flex-1 gap-2">
				<span class="text-sm text-muted-foreground">Notes</span>
				<textarea class="flex-1 w-full min-h-[8lh] transparent-text-area rounded-lg" value={feature.notes} onblur={async (e) => await updateFeatureMutation({})({ id: data.feature.id, notes: e.currentTarget.value })}/>
			</section>
		</div>
		<section>
